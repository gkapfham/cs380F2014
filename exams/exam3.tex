...
\item ({\bf 10 Points}) Answer the following questions about the use of machine learning algorithms during the processes
  of data mining and data warehousing. Your response to this question should be informed by the attribute definitions in
  Figure~\ref{fig:meaning} and the tree models in Figure~\ref{fig:trees}.
