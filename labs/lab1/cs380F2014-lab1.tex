...
and the {\tt git} command-line tool in the Ubuntu Linux operating system. After connecting to the course's Git
repository and creating your own repository, you will use a text editor to prepare a brief report on the features and
installation procedures associate with data management tools.
